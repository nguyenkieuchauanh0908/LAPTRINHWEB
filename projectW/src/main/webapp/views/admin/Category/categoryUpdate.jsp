		...
		<div class="row min-vh-100 flex-column flex-md-row">
			...
			<div class="container-fluid col-12 col-md-9 col-xl-10">
				<h2 style="margin-top: 30px; margin-left: 60px;">
					<b>Cập nhật thông tin loại sản phẩm</b>
				</h2>
				<div class="row">
					<div class="col-md-11">
						<!-- Form Elements -->
									...
									<div class="" style="padding: 70px; margin-top: -50px;">
										<form method="post" action="categoryUpdate">
											<div class="form-group">
												<label>Loại sản phẩm</label> <input style="margin-top:15px;" class="form-control"
													 name="cname" type="text" value="${cate._name}" />
											</div>
											<button type="submit" class="btn btn-primary"
												style="width: 100px; margin-top: 20px; padding-right: 7px;">Cập nhật
											</button>
