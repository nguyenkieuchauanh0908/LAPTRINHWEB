...
@WebServlet("/productAvailable")
public class productAvailableController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public int n =5;
    public productAvailableController() {
        super();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Product> producList = productDao.getAllAvailableProbyPage(indexpage,n); // lấy các sản phẩm thuộc trang thứ indexPage
																			// cần hiển thị
		...
		RequestDispatcher rq = req.getRequestDispatcher("views/admin/Product/productAvailable.jsp");
		rq.forward(req, resp);
	}
