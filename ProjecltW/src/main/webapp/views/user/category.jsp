			...
			<div class="col">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">${cate.categoryname}</li>
					</ol>
				</nav>
			</div>
		</div>
				...
				<div class="card bg-light mb-3">
					...
					<ul class="list-group category_block">
						<c:forEach items="${listcate}" var="c">
							<li class="list-group-item"${tagactive==c.categoryid ? "active":""}"><a
								href="category?cid=${c.categoryid}">${c.categoryname}</a></li>
						</c:forEach>
					</ul>
				</div>
			</div>
